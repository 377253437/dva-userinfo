...
var localeValues = {
  locale: 'zh-tw',
  Pagination: (0, _extends2["default"])((0, _extends2["default"])({}, _zh_TW["default"]), {
    prev_disable: '目前已在首頁',
    next_disable: '目前已在尾頁',
    page_show: '本頁顯示，第 ${num} 條',
    page_select: '切換每頁條數'
  }),
  BackTop: {
    backtop: '回到頂部'
  ...
  SelectPanel: {
    ...
    selectAll: '全選',
    placeholder: '請選擇',
    searchCount: '共找到 ${count} 條',
    totalCount: '共 ${count} 條數據',
    back: '返回',
    noData: '暫無數據',
    noResult: '搜尋無結果',
    noResultDesc: '未找到結果，請重新輸入'
  },
  SelectTransfer: {
    noData: '暫無數據',
    emptyText: '請從左側列表內選擇',
  ...
  Upload: {
    ...
    previewFile: '檔案預覽',
    downloadFile: '下载文件',
    triggerBtnTitle: '上傳檔案',
    triggerPictureTitle: '上傳圖片',
    triggerDragTitle: '點擊或拖拽檔案到此處上傳',
    remove: '刪除',
    cancel: '取消',
    cancelUpload: '取消上傳',
    download: '下載',
    maxCountTip: '最多可上傳 ${num} 個檔案',
    fileOverSize: '檔案大小超過限制',
    pictureOverSize: '圖片過大',
    preview: '預覽'
  },
  Empty: {
    description: '無此資料'
