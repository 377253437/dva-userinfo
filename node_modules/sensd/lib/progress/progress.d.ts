...
declare const ProgressStatuses: ["normal", "exception", "active", "success", "pause"];
...
export default class Progress extends React.Component<ProgressProps> {
    ...
    getProgressStatus(): "pause" | "normal" | "success" | "active" | "exception";
    renderProcessInfo(prefixCls: string): JSX.Element | null;
