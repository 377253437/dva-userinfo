...
var ProgressStatuses = (0, _type.tuple)('normal', 'exception', 'active', 'success', 'pause');
...
var Progress = /*#__PURE__*/function (_React$Component) {
  ...
  function Progress() {
    ...
    _this.renderProgress = function (_ref) {
      ...
      var progressInfo = _this.renderProcessInfo(prefixCls);
      ...
      return /*#__PURE__*/React.createElement("div", (0, _extends2["default"])({}, (0, _omit["default"])(restProps, ['status', 'format', 'trailColor', 'strokeWidth', 'width', 'gapDegree', 'gapPosition', 'strokeLinecap', 'percent', 'success', 'successPercent', 'infoMessage']), {
  ...
  (0, _createClass2["default"])(Progress, [{
    ...
    value: function renderProcessInfo(prefixCls) {
      ...
      var text = textFormatter((0, _utils.validProgress)(percent), (0, _utils.validProgress)(successPercent));
      var progressStatus = this.getProgressStatus();
      return /*#__PURE__*/React.createElement("span", {
        className: "".concat(prefixCls, "-text ").concat(prefixCls, "-").concat(progressStatus, "-text"),
