...
export declare type DrawerRef = {
    getWrapperContainer(): HTMLDivElement | null;
...
declare const SizeTypes: ["normal", "large", "small"];
...
declare const DrawerWrapper: React.FC<DrawerProps & React.RefAttributes<DrawerRef>>;
