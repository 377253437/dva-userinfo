...
var _rcDrawer = _interopRequireDefault(require("@sensd/rc-drawer"));
...
var SizeTypes = (0, _type.tuple)('normal', 'large', 'small');
...
var Drawer = /*#__PURE__*/React.forwardRef(function (_a, ref) {
  ...
  var width = _a.width,
      ...
      maskClosable = _a$maskClosable === void 0 ? false : _a$maskClosable,
      mask = _a.mask,
      _a$level = _a.level,
      ...
      closeIcon = _a$closeIcon === void 0 ? /*#__PURE__*/React.createElement(_LeftOutlined["default"], null) : _a$closeIcon,
      ...
      extra = _a.extra,
      extraTitle = _a.extraTitle,
      transition = _a.transition,
      rest = __rest(_a, ["width", "height", "size", "closable", "placement", "maskClosable", "mask", "level", "keyboard", "push", "closeIcon", "bodyStyle", "drawerStyle", "prefixCls", "className", "direction", "visible", "children", "zIndex", "destroyOnClose", "style", "title", "headerStyle", "onClose", "footer", "footerStyle", "extra", "extraTitle", "transition"]);
  ...
  var operations = React.useMemo(function () {
    return {
      ...
      // 获取 drawer 内容容器的 dom 节点
      getWrapperContainer: function getWrapperContainer() {
  ...
  var getOffsetStyle = function getOffsetStyle() {
    var getDefaultWidthOrHeight = function getDefaultWidthOrHeight() {
      switch (size) {
        case 'large':
          return '80%';
    ...
    if (placement === 'left' || placement === 'right') {
      var defaultWidth = getDefaultWidthOrHeight();
      offsetStyle.width = typeof width === 'undefined' ? defaultWidth : width;
    } else {
      var defaultHeight = getDefaultWidthOrHeight();
  ...
  function renderHeader() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: (0, _classnames["default"])("".concat(prefixCls, "-header"), (_classNames = {}, (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-header-close-only"), closable && !title && !extra), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-header-disable-close"), !closable), _classNames)),
      style: headerStyle
    }, /*#__PURE__*/React.createElement("div", null, extraTitle && /*#__PURE__*/React.createElement("div", {
      className: "".concat(prefixCls, "-header-extraTitle")
    }, extraTitle), /*#__PURE__*/React.createElement("div", {
  ...
  }; // 如果开发者显式定义了 width 或者在 style 中定义了 width，则不应该给其设置 size


  var noDefinedWidth = typeof width === 'undefined' && typeof ((_b = rest === null || rest === void 0 ? void 0 : rest.contentWrapperStyle) === null || _b === void 0 ? void 0 : _b.width) === 'undefined';
  var drawerClassName = (0, _classnames["default"])((_classNames2 = {}, (0, _defineProperty2["default"])(_classNames2, "".concat(prefixCls, "-rtl"), direction === 'rtl'), (0, _defineProperty2["default"])(_classNames2, "".concat(prefixCls, "-size-").concat(size), !!size && noDefinedWidth), (0, _defineProperty2["default"])(_classNames2, "".concat(prefixCls, "-disabled-transition"), typeof transition !== 'undefined' ? !transition : parentDrawer), _classNames2), className);
  var offsetStyle = getOffsetStyle();
  var mergedMask = typeof mask !== 'undefined' ? mask : !parentDrawer;
