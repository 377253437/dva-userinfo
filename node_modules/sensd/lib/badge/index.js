...
var Badge = function Badge(_a) {
  ...
  return /*#__PURE__*/React.createElement("span", (0, _extends2["default"])({}, restProps, {
    ...
    var scrollNumberCls = (0, _classnames["default"])((_classNames3 = {}, (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-dot"), isDot), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-count"), !isDot), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-count-not-a-wrapper"), !isDot && !children), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-count-sm"), size === 'small'), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-multiple-words"), !isDot && displayCount && displayCount.toString().length > 1), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-status-").concat(status), !!status), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-status-").concat(color), (0, _utils.isPresetColor)(color)), _classNames3));
...
Badge.Ribbon = _Ribbon["default"]; // 状态色/徽标/01_旭日红

Badge.DAWN_RED = '#e54545'; // 状态色/徽标/02_原野黄

Badge.STEPPE_YELLOW = '#fab300'; // 状态色/徽标/03_极光绿

Badge.AURORA_GREEN = '#5cb838'; // 状态色/徽标/04_冰靛蓝

Badge.ICE_BLUE = '#3170eb'; // 状态色/徽标/05_子夜黑

Badge.MIDNIGHT_DARK = '#747e94';
var _default = Badge;
