...
declare class Input extends React.Component<InputProps, InputState> {
    ...
    tryTriggerChangeCallback: (e: React.ChangeEvent<HTMLInputElement>) => void;
    handleReset: (e: React.MouseEvent<HTMLElement, MouseEvent>) => void;
    handleComposition: (e: React.CompositionEvent<HTMLInputElement>, callback: React.CompositionEventHandler<HTMLInputElement> | undefined) => void;
    renderInput: (prefixCls: string, size: SizeType | undefined, bordered: boolean, input?: ConfigConsumerProps['input'], concise?: boolean) => JSX.Element;
    clearPasswordValueAttribute: () => void;
    handleChangeCallback: (e: React.ChangeEvent<HTMLInputElement>) => void;
    handleChange: (e: React.ChangeEvent<HTMLInputElement>) => void;
    handleKeyDown: (e: React.KeyboardEvent<HTMLInputElement>) => void;
    renderShowCountSuffix: (prefixCls: string, hasFeedback?: boolean | undefined, feedbackIcon?: React.ReactNode, validateLayout?: "inline" | "vertical" | undefined) => JSX.Element | null;
