...
var InternalUpload = function InternalUpload(props, ref) {
  ...
  var fileList = props.fileList,
      ...
      formatFileBeforeChange = props.formatFileBeforeChange;
  ...
  var _React$useState3 = React.useState(false),
      ...
      hasDefaultTrigger = _React$useState4[0],
      setDefaultTrigger = _React$useState4[1];
  ...
  var onInternalChange = function onInternalChange(file, changedFileList, event) {
    ...
    } // append attrs when the size of the file is over max size.


    if (maxSize) {
      if (file.size && file.size > maxSize) {
        file.status = 'error';
        file.errorType = _interface.ErrorType.OverMaxSize;
        file.error = new Error();
      }

      cloneList = cloneList.map(function (f) {
        var finalFile = f;

        if (finalFile.size && finalFile.size > maxSize) {
          finalFile = (0, _extends2["default"])((0, _extends2["default"])({}, finalFile), {
            status: 'error',
            errorType: _interface.ErrorType.OverMaxSize,
            error: new Error()
          });
        }

        if (formatFileBeforeChange && typeof formatFileBeforeChange === 'function') {
          finalFile = formatFileBeforeChange(finalFile);
        }
    ...
    if (formatFileBeforeChange && typeof formatFileBeforeChange === 'function') {
      file = formatFileBeforeChange(file);
    }
  ...
  var onError = function onError(error, response, file) {
    ...
    targetItem.errorType = _interface.ErrorType.Network;
    targetItem.response = response;
  ...
  var isSinglePicture = hasDefaultTrigger && listType === 'picture-card' && maxCount === 1; // when is multi file, and use the default trigger, if over max count, set disabled

  var finalDisabled = disabled || !isSinglePicture && hasDefaultTrigger && typeof maxCount === 'number' && maxCount <= mergedFileList.length; // when set default trigger, and is single picture, judge whether file is uploaded; if uploaded, hide default trigger

  var defaultSinglePictureUploaded = isSinglePicture && mergedFileList.length === 1;
  ...
  var defaultTriggerType = 'button';

  if (type === 'drag') {
    defaultTriggerType = 'drag';
  } else if (listType === 'picture-card') {
    defaultTriggerType = 'picture';
  }

  var uploadContextValue = React.useMemo(function () {
    return {
      ...
      disabled: disabled,
      maxCount: maxCount,
      fileCount: mergedFileList.length,
      propLocale: propLocale,
      setDefaultTrigger: setDefaultTrigger
    };
  }, [defaultTriggerType, prefixCls, direction, disabled, maxCount, propLocale, mergedFileList]);
  ...
  var renderUploadList = function renderUploadList(button) {
    return showUploadList ? /*#__PURE__*/React.createElement(_LocaleReceiver["default"], {
      ...
      var _ref = typeof showUploadList === 'boolean' ? {} : showUploadList,
          ...
          showCancelIcon = _ref.showCancelIcon,
      ...
      return /*#__PURE__*/React.createElement(_UploadList["default"], {
        ...
        isSinglePicture: isSinglePicture,
  ...
  if (type === 'drag') {
    ...
    })), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-drag-hover"), dragState === 'dragover'), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-disabled"), finalDisabled), (0, _defineProperty2["default"])(_classNames, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames), className);
    return /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("div", {
      className: (0, _classnames["default"])((0, _defineProperty2["default"])({}, "".concat(prefixCls, "-drag-single-picture"), defaultSinglePictureUploaded))
      ...
      style: style
    }, /*#__PURE__*/React.createElement(_context2["default"].Provider, {
    ...
    }, children)))), isSinglePicture && mergedFileList.length === 0 ? null : renderUploadList()));
  }

  var uploadButtonCls = (0, _classnames["default"])(prefixCls, (_classNames3 = {}, (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-select"), true), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-select-").concat(listType), true), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-disabled"), finalDisabled), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-hidden"), !children || defaultSinglePictureUploaded), (0, _defineProperty2["default"])(_classNames3, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames3));
...
Upload.Trigger = _Trigger["default"];
