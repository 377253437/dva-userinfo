...
export declare type TriggerType = 'button' | 'picture' | 'drag';
...
export interface ShowUploadListInterface {
    ...
    cancelIcon?: React.ReactNode | ((file: UploadFile) => React.ReactNode);
...
export interface UploadLocale {
    ...
    triggerPictureTitle?: string;
    triggerDragTitle?: string;
    remove?: string;
    cancel?: string;
    cancelUpload?: string;
    download?: string;
...
export interface UploadProps<T = any> extends Pick<RcUploadProps, 'capture'> {
    ...
    formatFileBeforeChange?: (file: UploadFile) => UploadFile;
