...
function InternalTable(props, ref) {
  ...
  var tableProps = (0, _extends2["default"])((0, _extends2["default"])({}, (0, _omit["default"])(props, ['className', 'style', 'columns'])), {
    sticky: sticky
  });
  ...
  var wrapperEmptyText = function wrapperEmptyText(node, wrapperStyle) {
    if (!node) {
      return null;
    }

    var emptyNode = typeof node === 'function' ? node() : node;
  ...
  var wrapperClassNames = (0, _classnames["default"])("".concat(prefixCls, "-wrapper"), (_classNames2 = {}, (0, _defineProperty2["default"])(_classNames2, "".concat(prefixCls, "-wrapper-rtl"), direction === 'rtl'), (0, _defineProperty2["default"])(_classNames2, "".concat(prefixCls, "-wrapper-outline"), !bordered), (0, _defineProperty2["default"])(_classNames2, "".concat(prefixCls, "-no-bottom-pagination"), !bottomPaginationNode), _classNames2), className); // >>>>>>>>> loading

  var spinNode = null;

  if (spinProps === null || spinProps === void 0 ? void 0 : spinProps.spinning) {
    var bodyHeight = (_b = (_a = internalRefs.body.current) === null || _a === void 0 ? void 0 : _a.querySelector('tbody')) === null || _b === void 0 ? void 0 : _b.offsetHeight;
    var wrapperStyle = {
      height: "".concat(bodyHeight || 316, "px")
    };

    spinNode = function spinNode() {
      return wrapperEmptyText( /*#__PURE__*/React.createElement(_spin["default"], spinProps), wrapperStyle);
    };
  } // >>>> 合并单元格hover


  var curRowSpanHoverTr = React.useRef(null);

  var handleWrapperMouseMove = function handleWrapperMouseMove(event) {
    var hoverClassName = "".concat(prefixCls, "-cell-rowSpan-hover");
    var target = event.target;
    var rowSpan = target.rowSpan;

    if (target.tagName.toLowerCase() === 'td' && rowSpan > 1) {
      var tr = target.parentElement;
      var curIndex = rowSpan - 1;

      while (tr && curIndex >= 0) {
        var rect = tr.getBoundingClientRect();

        if (rect.top <= event.clientY && rect.top + rect.height >= event.clientY && tr !== curRowSpanHoverTr.current) {
          if (curRowSpanHoverTr.current) {
            // 把上一次的hover tr 取消掉
            curRowSpanHoverTr.current.querySelectorAll('td').forEach(function (td) {
              return td.classList.remove(hoverClassName);
            });
          }

          curRowSpanHoverTr.current = tr;
          tr.querySelectorAll('td').forEach(function (td) {
            var _a;

            if (((_a = td.rowSpan) !== null && _a !== void 0 ? _a : 1) === 1) {
              td.classList.add(hoverClassName);
            }
          });
          break;
        }
  ...
  var throttleMouseMove = React.useCallback((0, _throttle["default"])(handleWrapperMouseMove, 100, {
    leading: true
  }), []);

  if (skeleton) {
    var loadingProps = (0, _typeof2["default"])(skeleton) === 'object' ? skeleton : {};
    return /*#__PURE__*/React.createElement("div", {
      ref: ref,
      style: style
    }, /*#__PURE__*/React.createElement(_Loading["default"], (0, _extends2["default"])({
      prefixCls: prefixCls
    }, loadingProps)));
  }
  ...
  return (
    ...
    React.createElement("div", {
      ...
      onMouseOut: function onMouseOut() {
        curRowSpanHoverTr.current = null;
      }
    }, topPaginationNode && /*#__PURE__*/React.createElement("div", {
      className: "".concat(prefixCls, "-top-pagination")
    }, topPaginationNode), /*#__PURE__*/React.createElement(_rcTable["default"], (0, _extends2["default"])({}, tableProps, {
      ...
      data: (spinProps === null || spinProps === void 0 ? void 0 : spinProps.spinning) ? [] : pageData,
      rowKey: getRowKey,
      rowClassName: internalRowClassName,
      emptyText: spinNode || wrapperEmptyText(emptyText) || locale && locale.emptyText || renderEmpty('Table') // Internal
      ,
      internalHooks: _Table.INTERNAL_HOOKS,
      internalRefs: internalRefs,
      transformColumns: transformColumns
    })), bottomPaginationNode && /*#__PURE__*/React.createElement("div", {
      className: "".concat(prefixCls, "-bottom-pagination")
