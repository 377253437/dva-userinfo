...
var _DownOutlined = _interopRequireDefault(require("@sensd/icons/DownOutlined"));

var _treeUtil = require("@sensd/rc-tree/lib/utils/treeUtil");

var _conductUtil = require("@sensd/rc-tree/lib/utils/conductUtil");

var _util = require("@sensd/rc-tree/lib/util");

var _rcTable = require("rc-table");

var _valueUtil = require("rc-table/lib/utils/valueUtil");
...
function useSelection(rowSelection, config) {
  ...
  var transformColumns = (0, React.useCallback)(function (columns) {
    ...
    var renderSelectionCell = function renderSelectionCell(_, record, index) {
      ...
      return node;
    }; // 是否通过 SELECTION_COLUMN 自定义 SelectionColumn 位置


    var coustomSelectionColumn = false; // Insert selection column if not exist
    ...
    var newCloneColumns = cloneColumns.filter(function (col) {
      return col !== SELECTION_COLUMN;
    });

    if (coustomSelectionColumn || !newCloneColumns.length) {
      return cloneColumns.map(function (col) {
        return col === SELECTION_COLUMN ? selectionColumn : col;
      });
    }

    var firstIndex = newCloneColumns.findIndex(function (col) {
      var _a;

      return ((_a = col[_rcTable.INTERNAL_COL_DEFINE]) === null || _a === void 0 ? void 0 : _a.columnType) !== 'EXPAND_COLUMN';
    });
    return newCloneColumns.map(function (col, index) {
      if (index === firstIndex) {
        // 把 SELECTION_COLUMN 插入到第一列
        return (0, _extends2["default"])((0, _extends2["default"])({}, col), {
          title: function title(renderProps) {
            return /*#__PURE__*/React.createElement("div", {
              className: (0, _classnames["default"])(selectionColumn.className, (0, _defineProperty2["default"])({}, "".concat(prefixCls, "-without-selection-cell"), !selectionColumn.title))
            }, selectionColumn.title && /*#__PURE__*/React.createElement("div", {
              className: "".concat(prefixCls, "-selection-cell")
            }, selectionColumn.title), (0, _util2.renderColumnTitle)(col.title, renderProps));
          },
          render: function render(text, record, ind) {
            var childNode = !col.render ? (0, _valueUtil.getPathValue)(record, col.dataIndex) : col.render(text, record, ind);
            return /*#__PURE__*/React.createElement("div", {
              className: selectionColumn.className
            }, /*#__PURE__*/React.createElement("div", {
              className: "".concat(prefixCls, "-selection-cell")
            }, renderSelectionCell(text, record, ind)), childNode);
          }
        });
      }
