...
var _DownMiniFilled = _interopRequireDefault(require("@sensd/icons/DownMiniFilled"));

var _UpMiniFilled = _interopRequireDefault(require("@sensd/icons/UpMiniFilled"));
...
function injectSorter(prefixCls, columns, sorterSates, triggerSorter, defaultSortDirections, tableLocale, tableShowSorterTooltip, pos) {
  return (columns || []).map(function (column, index) {
    ...
    if (newColumn.sorter) {
      ...
      var upNode = sortDirections.includes(ASCEND) && /*#__PURE__*/React.createElement(_UpMiniFilled["default"], {
        className: (0, _classnames["default"])("".concat(prefixCls, "-column-sorter-up"), {
          active: sorterOrder === ASCEND
        })
      });
      var downNode = sortDirections.includes(DESCEND) && /*#__PURE__*/React.createElement(_DownMiniFilled["default"], {
      ...
      newColumn = (0, _extends3["default"])((0, _extends3["default"])({}, newColumn), {
        ...
        title: function title(renderProps) {
          var sortIconNode = /*#__PURE__*/React.createElement("span", {
          ...
          }, (0, _util.renderColumnTitle)(column.title, renderProps)), showSorterTooltip ? /*#__PURE__*/React.createElement(_tooltip["default"], tooltipProps, sortIconNode) : sortIconNode);
