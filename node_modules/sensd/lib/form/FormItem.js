...
exports.iconMap = exports["default"] = void 0;
...
var _CheckCircleFilled = _interopRequireDefault(require("@sensd/icons/CheckCircleFilled"));

var _ExclamationCircleFilled = _interopRequireDefault(require("@sensd/icons/ExclamationCircleFilled"));

var _ErrorFilled = _interopRequireDefault(require("@sensd/icons/ErrorFilled"));
...
function FormItem(props) {
  var name = props.name,
      ...
      hidden = props.hidden,
      hideErrorWhenChange = props.hideErrorWhenChange,
      _props$validateLayout = props.validateLayout,
      validateLayout = _props$validateLayout === void 0 ? 'vertical' : _props$validateLayout,
      restProps = __rest(props, ["name", "noStyle", "dependencies", "prefixCls", "style", "className", "shouldUpdate", "hasFeedback", "help", "rules", "validateStatus", "children", "required", "label", "messageVariables", "trigger", "validateTrigger", "hidden", "hideErrorWhenChange", "validateLayout"]);
  ...
  var _useContext2 = (0, React.useContext)(_context.FormContext),
      ...
      requireErrorIcon = _useContext2.requireErrorIcon,
      rowGutter = _useContext2.rowGutter;
  ...
  var _React$useState = React.useState(false),
      ...
      hideErrorTip = _React$useState2[0],
      setHideErrorTip = _React$useState2[1];

  var preValue = React.useRef(''); // ========================= MISC =========================
  ...
  var _React$useState3 = React.useState(function () {
    return genEmptyMeta();
      ...
      meta = _React$useState4[0],
      setMeta = _React$useState4[1];
  ...
  var onMetaChange = function onMetaChange(nextMeta) {
    ...
    if (noStyle && notifyParentMetaChange) {
      ...
      notifyParentMetaChange(hideErrorTip ? genEmptyMeta() : nextMeta, namePath);
    }
  ...
  var formItemStatusContext = React.useMemo(function () {
    var hasValidateIcon = validateLayout === 'inline' && ['error', 'warning'].includes(mergedValidateStatus);
    var mergedHasFeedback = hasFeedback || hasValidateIcon;
    var feedbackIcon;
    ...
    if (mergedHasFeedback) {
      ...
      if (hasValidateIcon) {
        var tipList = [].concat((0, _toConsumableArray2["default"])(debounceErrors), (0, _toConsumableArray2["default"])(debounceWarnings)).map(function (e) {
          return /*#__PURE__*/React.createElement("div", {
            key: e
          }, e);
        });
        feedbackIcon = /*#__PURE__*/React.createElement(_tooltip["default"], {
          title: tipList
        }, feedbackIcon);
      }
    }
  ...
  }, [mergedValidateStatus, hasFeedback, validateLayout, debounceErrors, debounceWarnings]); // ======================== Render ========================
  ...
  function renderLayout(baseChildren, fieldId, isRequired) {
    ...
    var itemClassName = (_itemClassName = {}, (0, _defineProperty2["default"])(_itemClassName, "".concat(prefixCls, "-item"), true), (0, _defineProperty2["default"])(_itemClassName, "".concat(prefixCls, "-item-with-help"), help || !hideErrorTip && (debounceErrors.length || debounceWarnings.length)), (0, _defineProperty2["default"])(_itemClassName, "".concat(className), !!className), (0, _defineProperty2["default"])(_itemClassName, "".concat(prefixCls, "-item-has-feedback"), mergedValidateStatus && hasFeedback), (0, _defineProperty2["default"])(_itemClassName, "".concat(prefixCls, "-item-has-success"), mergedValidateStatus === 'success'), (0, _defineProperty2["default"])(_itemClassName, "".concat(prefixCls, "-item-has-warning"), mergedValidateStatus === 'warning'), (0, _defineProperty2["default"])(_itemClassName, "".concat(prefixCls, "-item-has-error"), mergedValidateStatus === 'error'), (0, _defineProperty2["default"])(_itemClassName, "".concat(prefixCls, "-item-is-validating"), mergedValidateStatus === 'validating'), (0, _defineProperty2["default"])(_itemClassName, "".concat(prefixCls, "-item-hidden"), hidden), _itemClassName); // ======================= Children =======================
    ...
    return /*#__PURE__*/React.createElement(_row["default"], (0, _extends2["default"])({
      ...
      errors: hideErrorTip || validateLayout !== 'vertical' ? [] : debounceErrors,
      warnings: hideErrorTip || validateLayout !== 'vertical' ? [] : debounceWarnings,
      prefixCls: prefixCls,
      status: mergedValidateStatus,
      help: help
  ...
  return /*#__PURE__*/React.createElement(_rcFieldForm.Field, (0, _extends2["default"])({}, props, {
    ...
    if (Array.isArray(children) && hasName) {
      ...
      preValue.current = mergedControl[props.valuePropName || 'value']; // We should keep user origin event handler
      ...
      }); // 交互要求：input 默认为 blur 校验，在输入时内容有变更的时候，隐藏错误信息；等再次 blur 时再进行校验和展示错误
      // 但存在部分自定义表单组件（其中也存在输入框的情况），而像其它表单如 radio、checkbox、select 则是在 change 的时候校验
      // 为避免全局设置导致其他表单项出现错误展示异常，选择暴露出一个 props 进行设置，同时也能满足自定义组件中的校验

      if (hideErrorWhenChange && mergedValidateTrigger === 'onBlur') {
        var oldChange = childProps.onChange;
        var oldBlur = childProps.onBlur;

        childProps.onChange = function () {
          setHideErrorTip(true);
          oldChange === null || oldChange === void 0 ? void 0 : oldChange.apply(void 0, arguments);
        };

        childProps.onBlur = function () {
          // const debounceErrors = useDebounce(mergedErrors);
          // const debounceWarnings = useDebounce(mergedWarnings);
          // 这两个有 debounce 延迟（10ms），导致 className 设置有延迟
          setTimeout(function () {
            setHideErrorTip(false);
          }, 50);
          oldBlur === null || oldBlur === void 0 ? void 0 : oldBlur.apply(void 0, arguments);
        };
      }
