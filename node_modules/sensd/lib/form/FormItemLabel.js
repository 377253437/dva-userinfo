...
var FormItemLabel = function FormItemLabel(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_context.FormContext.Consumer, {
    ...
    var vertical = _ref2.vertical,
        ...
        contextLabelEllipsis = _ref2.labelEllipsis;

    var _a;

    var mergedLabelCol = labelCol || contextLabelCol || {};
    var mergedLabelEllipsis = labelEllipsis || contextLabelEllipsis;
    var mergedLabelWidth = labelWidth || contextLabelWidth;
    var mergedLabelAlign = labelAlign || contextLabelAlign;
    (0, _devWarning["default"])(!((mergedLabelCol === null || mergedLabelCol === void 0 ? void 0 : mergedLabelCol.span) && mergedLabelWidth), 'Form', 'labelWidth and labelCol.span cannot be set at the same time');
    ...
    if (typeof label === 'string' && mergedLabelEllipsis) {
      labelChildren = /*#__PURE__*/React.createElement(_typography["default"].Text, {
        ellipsis: {
          tooltip: true
        }
      }, labelChildren);
    ...
    return /*#__PURE__*/React.createElement(_col["default"], (0, _extends2["default"])({
      flex: mergedLabelWidth ? "0 0 ".concat(mergedLabelWidth) : undefined
    }, mergedLabelCol, {
      className: labelColClassName
    }), /*#__PURE__*/React.createElement("label", {
      htmlFor: htmlFor,
      className: labelClassName,
      title: typeof label === 'string' && !mergedLabelEllipsis ? label : ''
    }, labelChildren));
  });
};
