...
var InternalForm = function InternalForm(props, ref) {
  ...
  var customizePrefixCls = props.prefixCls,
      ...
      requireErrorIcon = props.requireErrorIcon,
      onFinishFailed = props.onFinishFailed,
      name = props.name,
      _props$rowGutter = props.rowGutter,
      rowGutter = _props$rowGutter === void 0 ? [8, 0] : _props$rowGutter,
      labelWidth = props.labelWidth,
      labelEllipsis = props.labelEllipsis,
      restFormProps = __rest(props, ["prefixCls", "className", "size", "form", "colon", "labelAlign", "labelWrap", "labelCol", "wrapperCol", "hideRequiredMark", "layout", "scrollToFirstError", "requiredMark", "requireErrorIcon", "onFinishFailed", "name", "rowGutter", "labelWidth", "labelEllipsis"]);
  ...
  var mergeRequireErrorIcon = (0, React.useMemo)(function () {
    if (requireErrorIcon !== undefined) {
      return requireErrorIcon;
    }

    return true;
  }, [requireErrorIcon, contextForm]);
  ...
  var formContextValue = (0, React.useMemo)(function () {
    return {
      ...
      requireErrorIcon: mergeRequireErrorIcon,
      itemRef: __INTERNAL__.itemRef,
      rowGutter: rowGutter,
      labelWidth: labelWidth,
      labelEllipsis: labelEllipsis
    };
  }, [name, labelAlign, labelCol, wrapperCol, layout, mergedColon, mergeRequireErrorIcon, mergedRequiredMark, rowGutter, labelWidth, labelEllipsis]);
