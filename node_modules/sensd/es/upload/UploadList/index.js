...
import FileLinkOutlined from "@sensd/icons/es/icons/FileLinkOutlined";
import PictureTwoTone from "@sensd/icons/es/icons/PictureTwoTone";
import FileTwoTone from "@sensd/icons/es/icons/FileTwoTone";
...
var InternalUploadList = function InternalUploadList(_ref, ref) {
  ...
  var type = _ref.type,
      ...
      isSinglePicture = _ref.isSinglePicture,
      showFileSize = _ref.showFileSize;
  ...
  var internalIconRender = function internalIconRender(file) {
    ...
    var icon = /*#__PURE__*/React.createElement(FileLinkOutlined, null);
  ...
  var listClassNames = classNames((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-list"), true), _defineProperty(_classNames, "".concat(prefixCls, "-list-").concat(listType), true), _defineProperty(_classNames, "".concat(prefixCls, "-list-drag"), type === 'drag'), _defineProperty(_classNames, "".concat(prefixCls, "-list-rtl"), direction === 'rtl'), _classNames)); // >>> Motion config
  ...
  var singlePictureAnimation = isSinglePicture ? null : 'animate-inline';
  var animationDirection = listType === 'picture-card' ? singlePictureAnimation : 'animate';
  var transitionName = animationDirection ? "".concat(prefixCls, "-").concat(animationDirection) : '';
  var motionConfig = {
    motionDeadline: 2000,
