...
import { convertDataToEntities } from "@sensd/rc-tree/es/utils/treeUtil";
import { conductCheck } from "@sensd/rc-tree/es/utils/conductUtil";
import { arrAdd, arrDel } from "@sensd/rc-tree/es/util";
...
import { renderColumnTitle } from '../util'; // TODO: warning if use ajax!!!
        ...
        return _extends(_extends({}, col), {
          title: function title(renderProps) {
            return /*#__PURE__*/React.createElement("div", {
              className: classNames(selectionColumn.className, _defineProperty({}, "".concat(prefixCls, "-without-selection-cell"), !selectionColumn.title))
            }, selectionColumn.title && /*#__PURE__*/React.createElement("div", {
              className: "".concat(prefixCls, "-selection-cell")
            }, selectionColumn.title), renderColumnTitle(col.title, renderProps));
          },
          render: function render(text, record, ind) {
            var childNode = !col.render ? getPathValue(record, col.dataIndex) : col.render(text, record, ind);
            return /*#__PURE__*/React.createElement("div", {
