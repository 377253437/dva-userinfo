...
import DownMiniFilled from "@sensd/icons/es/icons/DownMiniFilled";
import UpMiniFilled from "@sensd/icons/es/icons/UpMiniFilled";
...
function injectSorter(prefixCls, columns, sorterSates, triggerSorter, defaultSortDirections, tableLocale, tableShowSorterTooltip, pos) {
  return (columns || []).map(function (column, index) {
    ...
    if (newColumn.sorter) {
      ...
      var upNode = sortDirections.includes(ASCEND) && /*#__PURE__*/React.createElement(UpMiniFilled, {
        className: classNames("".concat(prefixCls, "-column-sorter-up"), {
          active: sorterOrder === ASCEND
        })
      });
      var downNode = sortDirections.includes(DESCEND) && /*#__PURE__*/React.createElement(DownMiniFilled, {
      ...
      newColumn = _extends(_extends({}, newColumn), {
        ...
        title: function title(renderProps) {
          ...
          }, renderColumnTitle(column.title, renderProps)), showSorterTooltip ? /*#__PURE__*/React.createElement(Tooltip, tooltipProps, sortIconNode) : sortIconNode);
