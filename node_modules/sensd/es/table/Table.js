...
function InternalTable(props, ref) {
  ...
  var tableProps = _extends(_extends({}, omit(props, ['className', 'style', 'columns'])), {
    sticky: sticky
  });
  ...
  var wrapperClassNames = classNames("".concat(prefixCls, "-wrapper"), (_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-wrapper-rtl"), direction === 'rtl'), _defineProperty(_classNames2, "".concat(prefixCls, "-wrapper-outline"), !bordered), _defineProperty(_classNames2, "".concat(prefixCls, "-no-bottom-pagination"), !bottomPaginationNode), _classNames2), className); // >>>>>>>>> loading
  ...
  if (spinProps === null || spinProps === void 0 ? void 0 : spinProps.spinning) {
    ...
    spinNode = function spinNode() {
      return wrapperEmptyText( /*#__PURE__*/React.createElement(Spin, spinProps), wrapperStyle);
    };
  } // >>>> 合并单元格hover
  ...
  var throttleMouseMove = React.useCallback(throttle(handleWrapperMouseMove, 100, {
    leading: true
  }), []);

  if (skeleton) {
    var loadingProps = _typeof(skeleton) === 'object' ? skeleton : {};
    return /*#__PURE__*/React.createElement("div", {
      ref: ref,
      style: style
  ...
  return (
    ...
    }, topPaginationNode), /*#__PURE__*/React.createElement(RcTable, _extends({}, tableProps, {
