...
import RcDrawer from '@sensd/rc-drawer';
...
var SizeTypes = tuple('normal', 'large', 'small');
...
var Drawer = /*#__PURE__*/React.forwardRef(function (_a, ref) {
  ...
  var width = _a.width,
      ...
      closeIcon = _a$closeIcon === void 0 ? /*#__PURE__*/React.createElement(LeftOutlined, null) : _a$closeIcon,
  ...
  function renderHeader() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: classNames("".concat(prefixCls, "-header"), (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-header-close-only"), closable && !title && !extra), _defineProperty(_classNames, "".concat(prefixCls, "-header-disable-close"), !closable), _classNames)),
      style: headerStyle
  ...
  var drawerClassName = classNames((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _defineProperty(_classNames2, "".concat(prefixCls, "-size-").concat(size), !!size && noDefinedWidth), _defineProperty(_classNames2, "".concat(prefixCls, "-disabled-transition"), typeof transition !== 'undefined' ? !transition : parentDrawer), _classNames2), className);
