...
function FormItem(props) {
  ...
  var formItemStatusContext = React.useMemo(function () {
    ...
    if (mergedHasFeedback) {
      ...
      if (hasValidateIcon) {
        var tipList = [].concat(_toConsumableArray(debounceErrors), _toConsumableArray(debounceWarnings)).map(function (e) {
          return /*#__PURE__*/React.createElement("div", {
            key: e
          }, e);
        });
        feedbackIcon = /*#__PURE__*/React.createElement(Tooltip, {
          title: tipList
        }, feedbackIcon);
      }
    }
  ...
  function renderLayout(baseChildren, fieldId, isRequired) {
    ...
    var itemClassName = (_itemClassName = {}, _defineProperty(_itemClassName, "".concat(prefixCls, "-item"), true), _defineProperty(_itemClassName, "".concat(prefixCls, "-item-with-help"), help || !hideErrorTip && (debounceErrors.length || debounceWarnings.length)), _defineProperty(_itemClassName, "".concat(className), !!className), _defineProperty(_itemClassName, "".concat(prefixCls, "-item-has-feedback"), mergedValidateStatus && hasFeedback), _defineProperty(_itemClassName, "".concat(prefixCls, "-item-has-success"), mergedValidateStatus === 'success'), _defineProperty(_itemClassName, "".concat(prefixCls, "-item-has-warning"), mergedValidateStatus === 'warning'), _defineProperty(_itemClassName, "".concat(prefixCls, "-item-has-error"), mergedValidateStatus === 'error'), _defineProperty(_itemClassName, "".concat(prefixCls, "-item-is-validating"), mergedValidateStatus === 'validating'), _defineProperty(_itemClassName, "".concat(prefixCls, "-item-hidden"), hidden), _itemClassName); // ======================= Children =======================
