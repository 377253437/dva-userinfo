...
import ErrorFilledfrom from "@sensd/icons/es/icons/ErrorFilled";
...
export default function ErrorList(_ref) {
  ...
  var fullKeyList = React.useMemo(function () {
    var validateMessages = [].concat(_toConsumableArray(errors.map(function (error, index) {
  ...
  return /*#__PURE__*/React.createElement(CSSMotion, _extends({}, collapseMotion, {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: itemStyle
      }, error && errorStatus === 'error' && requireErrorIcon && /*#__PURE__*/React.createElement(ErrorFilledfrom, null), error);
    }));
  });
}