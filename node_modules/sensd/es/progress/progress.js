...
var ProgressStatuses = tuple('normal', 'exception', 'active', 'success', 'pause');
...
var Progress = /*#__PURE__*/function (_React$Component) {
  ...
  function Progress() {
    ...
    _this.renderProgress = function (_ref) {
      ...
      return /*#__PURE__*/React.createElement("div", _extends({}, omit(restProps, ['status', 'format', 'trailColor', 'strokeWidth', 'width', 'gapDegree', 'gapPosition', 'strokeLinecap', 'percent', 'success', 'successPercent', 'infoMessage']), {
  ...
  _createClass(Progress, [{
    ...
    value: function renderProcessInfo(prefixCls) {
      ...
      var text = textFormatter(validProgress(percent), validProgress(successPercent));
