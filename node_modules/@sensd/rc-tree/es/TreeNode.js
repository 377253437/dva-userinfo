...
var InternalTreeNode = /*#__PURE__*/function (_React$Component) {
  ...
  function InternalTreeNode() {
    ...
    _this.onSelectorClick = function (e) {
      ...
      onNodeClick(e, convertNodePropsToEventData(_this.props)); // 在 checkable 模式下，无论是子元素还是父元素
    ...
    _this.renderCheckbox = function () {
      ...
      return CheckBoxText( /*#__PURE__*/React.createElement("span", {
        className: classNames("".concat(prefixCls, "-checkbox"), checked && "".concat(prefixCls, "-checkbox-checked"), halfChecked && "".concat(prefixCls, "-checkbox-indeterminate"), (disabled || disableCheckbox) && "".concat(prefixCls, "-checkbox-disabled")),
