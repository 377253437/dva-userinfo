...
import { BasicDataNode, DataEntity, DataNode, Direction, EventDataNode, FieldNames, FlattenNode, IconType, Key, NodeInstance, ScrollTo } from './interface';
...
export interface TreeProps<TreeDataType extends BasicDataNode = DataNode> {
    ...
    selectedKeys?: Key[];
    tooltip?: React.Component<any, any>;
    checkboxTooltipText?: React.ReactNode;
...
declare class Tree<TreeDataType extends BasicDataNode = DataNode> extends React.Component<TreeProps<TreeDataType>, TreeState<TreeDataType>> {
    ...
    onNodeExpand: (e: React.MouseEvent, treeNode: EventDataNode) => void;
