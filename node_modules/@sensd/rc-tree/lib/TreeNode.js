...
var InternalTreeNode = /*#__PURE__*/function (_React$Component) {
  ...
  function InternalTreeNode() {
    ...
    _this.onSelectorClick = function (e) {
      ...
      onNodeClick(e, (0, _treeUtil.convertNodePropsToEventData)(_this.props)); // 在 checkable 模式下，无论是子元素还是父元素
      // 点击右侧内容区域优先触发 onCheck 事件

      if (_this.isCheckable()) {
        _this.onCheck(e);
      } else if (_this.isSelectable()) {
        _this.onSelect(e);
      }
    };
    ...
    _this.renderCheckbox = function () {
      var _this$props5 = _this.props,
          ...
          hasTooltip = _this$props5.hasTooltip;
      var _this$props$context3 = _this.props.context,
          prefixCls = _this$props$context3.prefixCls,
          Tooltip = _this$props$context3.tooltip,
          checkboxTooltipText = _this$props$context3.checkboxTooltipText;
      ...
      var CheckBoxText = function CheckBoxText(CheckBox, hasSelectAllTip) {
        if (hasSelectAllTip && Tooltip) {
          return (
            /*#__PURE__*/
            // 部分选项状态不可更改
            // @ts-ignore
      ...
      return CheckBoxText( /*#__PURE__*/React.createElement("span", {
        className: (0, _classnames.default)("".concat(prefixCls, "-checkbox"), checked && "".concat(prefixCls, "-checkbox-checked"), halfChecked && "".concat(prefixCls, "-checkbox-indeterminate"), (disabled || disableCheckbox) && "".concat(prefixCls, "-checkbox-disabled")),
    ...
    _this.renderSelector = function () {
      ...
      var _this$props$context4 = _this.props.context,
          ...
          showIcon = _this$props$context4.showIcon,
          treeIcon = _this$props$context4.icon,
          loadData = _this$props$context4.loadData,
          titleRender = _this$props$context4.titleRender;
    ...
    _this.renderDropIndicator = function () {
      ...
      var _this$props$context5 = _this.props.context,
          ...
          dropLevelOffset = _this$props$context5.dropLevelOffset,
          dropPosition = _this$props$context5.dropPosition,
          prefixCls = _this$props$context5.prefixCls,
          indent = _this$props$context5.indent,
          dropIndicatorRender = _this$props$context5.dropIndicatorRender,
          dragOverNodeKey = _this$props$context5.dragOverNodeKey,
          direction = _this$props$context5.direction;
