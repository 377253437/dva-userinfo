...
<p align="center">
⭐ The abstract node of the Sens Design SVG icons.
</p>
...
```bash
# use yarn
$ yarn add @sensd/result-svg

# or use npm
$ npm install @sensd/result-svg --save
```

## Get started

```ts
import { AccountBookOutlined } from '@sensd/result-svg';
// or
// import AccountBookOutlined from '@sensd/result-svg/es/asn/AccountBookOutlined';
...
```ts
import { AccountBookFilled } from '@sensd/result-svg';
import { renderIconDefinitionToSVGElement } from '@sensd/result-svg/es/helpers';
