...
import type { OptionRenderOptions } from './interface';
...
export interface SelectProps<ValueType = any, OptionType extends BaseOptionType = DefaultOptionType> extends Omit<BaseSelectPropsWithoutPrivate, 'customerSelector'> {
    prefixCls?: string;
    id?: string;
    backfill?: boolean;
    fieldNames?: FieldNames;
    ...
    customOption?: (data: BaseOptionType) => React.ReactNode;
    dropdownAutoClose?: boolean;
    groupType?: 'box' | 'line';
    customerSelector?: (options: CustomSelectorOptions) => React.ReactNode;
    optionRender?: (select: React.ReactNode, options: OptionRenderOptions) => React.ReactElement;
}
