...
var _excluded = ["disabled", "title", "style", "className"];
...
var OptionList = function OptionList(_, ref) {
  var _useBaseProps = (0, _useBaseProps2.default)(),
      ...
      customOption = _useBaseProps.customOption,
      _useBaseProps$groupTy = _useBaseProps.groupType,
      groupType = _useBaseProps$groupTy === void 0 ? 'box' : _useBaseProps$groupTy,
      notFoundContent = _useBaseProps.notFoundContent,
      onPopupScroll = _useBaseProps.onPopupScroll,
      dropdownAutoClose = _useBaseProps.dropdownAutoClose,
      optionRender = _useBaseProps.optionRender;

  var _React$useContext = React.useContext(_SelectContext.default),
      valueOptions = _React$useContext.valueOptions,
  ...
  if (!optionRender && memoFlattenOptions.length === 0) {
  ...
  var select = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    role: "listbox",
    id: "".concat(id, "_list"),
    style: {
      height: 0,
    ...
    var passedProps = (0, _omit.default)(otherProps, [].concat((0, _toConsumableArray2.default)(omitFieldNameList), ['detail', 'prefixIcon', 'suffixIcon'])); // Option

    var selected = rawValues.has(value);
    var optionPrefixCls = "".concat(itemPrefixCls, "-option");
    var optionClassName = (0, _classnames.default)(itemPrefixCls, optionPrefixCls, className, (_classNames2 = {}, (0, _defineProperty2.default)(_classNames2, "".concat(optionPrefixCls, "-grouped"), groupOption), (0, _defineProperty2.default)(_classNames2, "".concat(optionPrefixCls, "-active"), activeIndex === itemIndex), (0, _defineProperty2.default)(_classNames2, "".concat(optionPrefixCls, "-disabled"), disabled), (0, _defineProperty2.default)(_classNames2, "".concat(optionPrefixCls, "-selected"), selected), _classNames2));
    var mergedLabel = getLabel(item);
    ...
    var others = (0, _omit.default)(data, ['content', 'optionTitle']);
    return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, passedProps, {
      "aria-selected": selected,
      className: optionClassName,
      title: !customOption ? optionTitle : null,
    ...
    }, (customOption === null || customOption === void 0 ? void 0 : customOption((0, _objectSpread2.default)({
      optionTitle: optionTitle,
      content: content
    }, others))) || content), /*#__PURE__*/React.isValidElement(menuItemSelectedIcon) || selected, iconVisible && /*#__PURE__*/React.createElement(_TransBtn.default, {
  ...
  return (optionRender === null || optionRender === void 0 ? void 0 : optionRender(select, {
    options: options,
    flattenOptions: memoFlattenOptions,
    rawValues: rawValues,
