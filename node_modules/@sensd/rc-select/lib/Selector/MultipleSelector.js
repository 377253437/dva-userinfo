...
var SelectSelector = function SelectSelector(props) {
  ...
  var inputNode = /*#__PURE__*/React.createElement("div", {
    className: (0, _classnames.default)((0, _defineProperty2.default)({}, "".concat(selectionPrefixCls, "-search"), inputEditable)),
    style: {
      width: inputEditable ? inputWidth : 0
    },
  ...
  var originSelector = mode === 'tags' || showSearch; // 自定义 Selector，不支持: tags 模式、带清除功能、带搜索功能、自定义 tag

  if (!allowClear && !originSelector && customerSelector && !tagRender) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, inputNode, customerSelector());
  }
