...
var Form = /*#__PURE__*/function (_React$Component) {
  ...
  function Form(props) {
    ...
    _this.renderForm = function (_ref) {
      ...
      var formProps = (0, _omit.default)(_this.props, ['prefixCls', 'className', 'layout', 'form', 'hideRequiredMark', 'wrapperCol', 'labelAlign', 'labelCol', 'rowGutter', 'colon']);
  ...
  _createClass(Form, [{
    ...
    value: function componentDidMount() {
      try {
        (0, _warning.default)(getComputedStyle(document.querySelector('.sens-col'), null).getPropertyValue('position') === 'relative', 'Form', 'If missing `Grid` style, you should import it, Please follow https://github.com/ant-design/compatible#faq.');
      } catch (error) {
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          rowGutter = _this$props2.rowGutter,
          layout = _this$props2.layout,
          colon = _this$props2.colon,
          requireErrorIcon = _this$props2.requireErrorIcon;
