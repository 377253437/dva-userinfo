...
var Form = /*#__PURE__*/function (_React$Component) {
  ...
  function Form(props) {
    ...
    _this.renderForm = function (_ref) {
      ...
      var formProps = omit(_this.props, ['prefixCls', 'className', 'layout', 'form', 'hideRequiredMark', 'wrapperCol', 'labelAlign', 'labelCol', 'rowGutter', 'colon']);
  ...
  _createClass(Form, [{
    ...
    value: function componentDidMount() {
      try {
        warning(getComputedStyle(document.querySelector('.sens-col'), null).getPropertyValue('position') === 'relative', 'Form', 'If missing `Grid` style, you should import it, Please follow https://github.com/ant-design/compatible#faq.');
      } catch (error) {
