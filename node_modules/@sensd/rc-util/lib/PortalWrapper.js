...
var PortalWrapper = /*#__PURE__*/function (_React$Component) {
  ...
  function PortalWrapper(props) {
    ...
    _this.updateOpenCount = function (prevProps) {
      ...
      // preVisible 或 visible 可能为 undefined，false !== undefined，也会导致未打开弹出层的情况下 openCount - 1

      if (Boolean(visible) !== Boolean(prevVisible) && supportDom && getParent(getContainer) === document.body) {
