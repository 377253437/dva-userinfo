...
```bash
# use yarn
$ yarn add @sensd/icons-svg

# or use npm
$ npm install @sensd/icons-svg --save
```

## Get started

```ts
import { AccountBookOutlined } from '@sensd/icons-svg';
// or
// import AccountBookOutlined from '@sensd/icons-svg/es/asn/AccountBookOutlined';
...
```ts
import { AccountBookFilled } from '@sensd/icons-svg';
import { renderIconDefinitionToSVGElement } from '@sensd/icons-svg/es/helpers';
