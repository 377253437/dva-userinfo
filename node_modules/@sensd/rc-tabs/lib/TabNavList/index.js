...
function TabNavList(props, ref) {
  ...
  var className = props.className,
      ...
      _props$boundaryOffset = props.boundaryOffset,
      boundaryOffset = _props$boundaryOffset === void 0 ? 0 : _props$boundaryOffset,
      _props$dropdownMode = props.dropdownMode,
      dropdownMode = _props$dropdownMode === void 0 ? 'all' : _props$dropdownMode;
  ...
  function scrollToTab() {
    ...
    if (tabPositionTopOrBottom) {
      ...
      if (rtl) {
        ...
        newTransform = -tabOffset.left + boundaryOffset;
      } else if (tabOffset.left + tabOffset.width > -transformLeft + wrapperWidth) {
        newTransform = -(tabOffset.left + tabOffset.width - wrapperWidth) - boundaryOffset;
      }
  ...
  var hasDropdown = !!hiddenTabs.length; // 更多下拉显示tabs

  var dropdownTabs = [];

  if (hasDropdown) {
    dropdownTabs = dropdownMode === 'more' ? hiddenTabs : tabs;
  }
