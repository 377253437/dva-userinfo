...
export interface TabNavListProps {
    ...
    moreIcon?: React.ReactNode | ((dropdownVisible: boolean) => React.ReactNode);
    ...
    dropdownItemRenderWrapper?: (node: React.ReactNode) => React.ReactElement;
    dropdownMode?: 'all' | 'more';
}
