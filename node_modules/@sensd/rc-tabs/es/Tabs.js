...
var _excluded = ["id", "prefixCls", "className", "children", "direction", "activeKey", "defaultActiveKey", "editable", "animated", "tabPosition", "tabBarGutter", "tabBarStyle", "tabBarExtraContent", "locale", "moreIcon", "moreDropdownMode", "moreDropdownProps", "moreDropdownItemRenderWrapper", "boundaryOffset", "moreTransitionName", "destroyInactiveTabPane", "renderTabBar", "onChange", "onTabClick", "onTabScroll"];
...
function Tabs(_ref, ref) {
  ...
  var id = _ref.id,
    ...
    tabPane: false
      ...
      moreDropdownMode = _ref.moreDropdownMode,
      moreDropdownProps = _ref.moreDropdownProps,
      moreDropdownItemRenderWrapper = _ref.moreDropdownItemRenderWrapper,
      boundaryOffset = _ref.boundaryOffset,
  ...
  var tabNavBarProps = _objectSpread(_objectSpread({}, sharedProps), {}, {
    ...
    locale: locale,
    moreIcon: moreIcon,
    dropdownMode: moreDropdownMode,
    dropdownProps: moreDropdownProps,
    dropdownItemRenderWrapper: moreDropdownItemRenderWrapper,
