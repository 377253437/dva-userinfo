...
export interface TabsProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onChange'> {
    ...
    locale?: TabsLocale;
    moreIcon?: React.ReactNode | ((props: any) => React.ReactNode);
    moreDropdownMode?: 'all' | 'more';
    moreDropdownProps?: Omit<DropdownProps, 'children'>;
    moreDropdownItemRenderWrapper?: (node: React.ReactNode) => React.ReactElement;
