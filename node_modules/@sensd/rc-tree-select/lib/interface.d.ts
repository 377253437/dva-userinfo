...
import type { OnInternalSelect, InternalTriggerChange } from './TreeSelect';
...
export declare type KeyEntities = Record<RawValueType, DataEntity<any>>;
export interface OptionRenderOptions<T> {
    treeData: T[];
