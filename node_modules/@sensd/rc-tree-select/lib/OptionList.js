...
var _rcTree = _interopRequireDefault(require("@sensd/rc-tree"));
...
var OptionList = function OptionList(_, ref) {
  ...
  var _React$useContext2 = React.useContext(_LegacyContext.default),
      ...
      treeClassName = _React$useContext2.treeClassName,
      optionRender = _React$useContext2.optionRender,
      dropdownAutoClose = _React$useContext2.dropdownAutoClose;
  ...
  var onInternalCheck = function onInternalCheck(__, info) {
    var node = info.node;
  ...
  var onInternalSelect = function onInternalSelect(__, info) {
    var node = info.node; // 限制叶子结点才可以选中；如需加入单选支持选中任意节点，需 @sensd/rc-tree 提供 api 支持

    if (!multiple && !node.children) {
      onInternalCheck(__, info);
    }
  }; // ========================= Keyboard =========================
  ...
  var tree = /*#__PURE__*/React.createElement(_rcTree.default, (0, _extends2.default)({
    ref: treeRef,
    focusable: false,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: HIDDEN_STYLE,
    "aria-live": "assertive"
  }, activeEntity.node.value), optionRender ? optionRender(tree, {
    treeData: treeData,
    fieldNames: fieldNames,
