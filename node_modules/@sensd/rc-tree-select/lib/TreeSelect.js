...
var _rcSelect = require("@sensd/rc-select");

var _conductUtil = require("@sensd/rc-tree/lib/utils/conductUtil");

var _useId = _interopRequireDefault(require("@sensd/rc-select/lib/hooks/useId"));
...
var _excluded = ["id", "prefixCls", "value", "defaultValue", "onChange", "onSelect", "onDeselect", "searchValue", "inputValue", "onSearch", "autoClearSearchValue", "filterTreeNode", "treeNodeFilterProp", "showCheckedStrategy", "treeNodeLabelProp", "customerSelector", "multiple", "treeCheckable", "treeCheckStrictly", "labelInValue", "fieldNames", "treeDataSimpleMode", "treeData", "children", "loadData", "treeLoadedKeys", "onTreeLoad", "treeDefaultExpandAll", "treeExpandedKeys", "treeDefaultExpandedKeys", "onTreeExpand", "virtual", "listHeight", "listItemHeight", "optionRender", "onDropdownVisibleChange", "dropdownMatchSelectWidth", "dropdownAutoClose", "treeLine", "treeIcon", "showTreeIcon", "switcherIcon", "treeMotion", "treeClassName"];
...
var TreeSelect = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var id = props.id,
      ...
      customerSelector = props.customerSelector,
      ...
      _props$dropdownAutoCl = props.dropdownAutoClose,
      dropdownAutoClose = _props$dropdownAutoCl === void 0 ? true : _props$dropdownAutoCl,
  ...
  var getDisplayValues = React.useCallback(function (innerRawCheckedValues, innerRawLabeledValues) {
    // Collect keys which need to show
    var displayKeys = (0, _strategyUtil.formatStrategyValues)(innerRawCheckedValues, showCheckedStrategy, keyEntities, mergedFieldNames); // Convert to value and filled with label
    ...
    var labeledValues = values.map(function (val) {
      var targetItem = innerRawLabeledValues.find(function (item) {
  ...
  }, [mergedFieldNames, mergedMultiple, convert2LabelValues, showCheckedStrategy, keyEntities]); // Convert rawCheckedKeys to check strategy related values

  var displayValues = React.useMemo(function () {
    return getDisplayValues(rawCheckedValues, rawLabeledValues);
  }, [rawCheckedValues, rawLabeledValues, getDisplayValues]);
  ...
  }, [virtual, dropdownMatchSelectWidth, listHeight, listItemHeight, filteredTreeData, mergedFieldNames, onOptionSelect, triggerChange]); // ======================= Legacy Context =======================
  ...
  }, [mergedCheckable, loadData, treeLoadedKeys, onTreeLoad, rawCheckedValues, rawHalfCheckedValues, treeDefaultExpandAll, treeExpandedKeys, treeDefaultExpandedKeys, onTreeExpand, treeIcon, treeMotion, showTreeIcon, switcherIcon, treeLine, treeNodeFilterProp, keyEntities, treeClassName, optionRender, dropdownAutoClose]);

  var internalCustomerSelector = function internalCustomerSelector() {
    return customerSelector === null || customerSelector === void 0 ? void 0 : customerSelector({
  ...
  return /*#__PURE__*/React.createElement(_TreeSelectContext.default.Provider, {
    ...
    dropdownMatchSelectWidth: dropdownMatchSelectWidth // @ts-ignore
    ,
    customerSelector: internalCustomerSelector
  }))));
